...
tenfold_xval <-
  trainControl(method = 'cv',
               number = 10,
               p = 0.9,
               summaryFunction = prSummary) # precision and recall summary (two statistics needed for F1 score)
```
...
model_2a <-
  train(y = beans_y_train$Class,
        ...
        metric = 'F_meas') # F1 metric for performance (keeps saying "not in result set"...)
```
