...
macro_f1 <- function(data, lev = NULL, model = NULL) { # same args as a function called defaultSummary()
  mF1 <- mean(f1(data$pred, data$obs)) 
}
...
```{r test_matrix}
test_table <- data.table(actual = c(1,2,3,4),
           predicted = c(5,6,7,8))
